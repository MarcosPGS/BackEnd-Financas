...
import com.marcos.minhasFinancas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentoService{
	...
	public Lancamento atualizar(Lancamento lancamento) {
		Objects.requireNonNull(lancamento.getId()); //Verifica se a referência de objeto especificada não é null.
		validar(lancamento);
		return repository.save(lancamento);
	}
